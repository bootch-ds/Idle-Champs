...
;----------------------------	
;design window sizes
	global gWindowWidth_Default 	:= 1286
	global gWindowHeight_Default	:= 749
...
;variables pertaining to manipulating the champion roster (and click damage upgrade)
	...
	global roster_y			:= 715			; vertical location of the a point in the upper left corner of the click damage button
